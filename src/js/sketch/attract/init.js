...
export default function () {
  ...
  const render = () => {
    ...
    points.material.uniforms.velocity.value =
      physics_renderer.getCurrentVelocity();
    points.material.uniforms.acceleration.value =
      physics_renderer.getCurrentAcceleration();
  ...
  const on = () => {
    ...
    const touchMove = (x, y, touch_event) => {
      ...
      physics_renderer.accelerationMesh.material.uniforms.anchor.value.copy(
        vectorTouchMove
      );
    };
    ...
    const mouseOut = () => {
      ...
      physics_renderer.accelerationMesh.material.uniforms.anchor.value.set(
        0,
        0,
        0
      );
